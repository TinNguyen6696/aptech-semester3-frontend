        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a href="/contests" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-5 py-3 rounded-lg transition-colors shadow-sm">
                <span className="text-base leading-none">+</span> Share your talent
              </a>
              <a href="explores" className="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-800 text-sm font-semibold px-5 py-3 rounded-lg border border-gray-200 transition-colors">
                Explore stories
              </a>
            </div>
